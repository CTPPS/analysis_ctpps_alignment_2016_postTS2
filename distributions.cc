...
int main()
{
	...
	TH2D *h2_y_vs_x_L_1_N_no_sel = new TH2D("h2_y_vs_x_L_1_N_no_sel", ";x;y", n_bins_x, x_min_str, x_max_str, n_bins_y, y_min, y_max);
	TH2D *h2_y_vs_x_R_1_N_no_sel = new TH2D("h2_y_vs_x_R_1_N_no_sel", ";x;y", n_bins_x, x_min_str, x_max_str, n_bins_y, y_min, y_max);
	TH2D *h2_y_vs_x_R_1_F_no_sel = new TH2D("h2_y_vs_x_R_1_F_no_sel", ";x;y", n_bins_x, x_min_str, x_max_str, n_bins_y, y_min, y_max);

	TH2D *h2_x_L_1_F_vs_x_L_1_N_before = new TH2D("h2_x_L_1_F_vs_x_L_1_N_before", ";x_L_1_N;x_L_1_F", n_bins_x, x_min_str, x_max_str, n_bins_x, x_min_str, x_max_str);
	TH2D *h2_x_L_1_F_vs_x_L_1_N_after = new TH2D("h2_x_L_1_F_vs_x_L_1_N_after", ";x_L_1_N;x_L_1_F", n_bins_x, x_min_str, x_max_str, n_bins_x, x_min_str, x_max_str);
	TProfile *p_x_L_1_F_vs_x_L_1_N_after = new TProfile("p_x_L_1_F_vs_x_L_1_N_after", ";x_L_1_N;x_L_1_F", n_bins_x, x_min_str, x_max_str);
	...
	TH2D *h2_x_R_1_F_vs_x_R_1_N_before = new TH2D("h2_x_R_1_F_vs_x_R_1_N_before", ";x_R_1_N;x_R_1_F", n_bins_x, x_min_str, x_max_str, n_bins_x, x_min_str, x_max_str);
	TH2D *h2_x_R_1_F_vs_x_R_1_N_after = new TH2D("h2_x_R_1_F_vs_x_R_1_N_after", ";x_R_1_N;x_R_1_F", n_bins_x, x_min_str, x_max_str, n_bins_x, x_min_str, x_max_str);
	TProfile *p_x_R_1_F_vs_x_R_1_N_after = new TProfile("p_x_R_1_F_vs_x_R_1_N_after", ";x_R_1_N;x_R_1_F", n_bins_x, x_min_str, x_max_str);
	...
	TH2D *h2_y_L_1_F_vs_y_L_1_N_before = new TH2D("h2_y_L_1_F_vs_y_L_1_N_before", ";y_L_1_N;y_L_1_F", 100, -10., +10., 100, -10., +10.);
	TH2D *h2_y_L_1_F_vs_y_L_1_N_after = new TH2D("h2_y_L_1_F_vs_y_L_1_N_after", ";y_L_1_N;y_L_1_F", 100, -10., +10., 100, -10., +10.);
	TProfile *p_y_L_1_F_vs_y_L_1_N_after = new TProfile("p_y_L_1_F_vs_y_L_1_N_after", ";y_L_1_N;y_L_1_F", 100, -10., +10.);
	...
	TH2D *h2_y_R_1_F_vs_y_R_1_N_before = new TH2D("h2_y_R_1_F_vs_y_R_1_N_before", ";y_R_1_N;y_R_1_F", 100, -10., +10., 100, -10., +10.);
	TH2D *h2_y_R_1_F_vs_y_R_1_N_after = new TH2D("h2_y_R_1_F_vs_y_R_1_N_after", ";y_R_1_N;y_R_1_F", 100, -10., +10., 100, -10., +10.);
	TProfile *p_y_R_1_F_vs_y_R_1_N_after = new TProfile("p_y_R_1_F_vs_y_R_1_N_after", ";y_R_1_N;y_R_1_F", 100, -10., +10.);
	...
	TH2D *h2_y_vs_x_L_1_N_sel = new TH2D(*h2_y_vs_x_L_1_N_no_sel); h2_y_vs_x_L_1_N_sel->SetName("h2_y_vs_x_L_1_N_sel");
	TH2D *h2_y_vs_x_R_1_N_sel = new TH2D(*h2_y_vs_x_R_1_N_no_sel); h2_y_vs_x_R_1_N_sel->SetName("h2_y_vs_x_R_1_N_sel");
	...
	for (ev.toBegin(); ! ev.atEnd(); ++ev)
	{
		...
		CTPPSLocalTrackLite tr_L_1_N;
		CTPPSLocalTrackLite tr_R_1_N;
		...
		bool tr_L_1_N_valid = (tr_L_1_N.getRPId() != 0);
		bool tr_R_1_N_valid = (tr_R_1_N.getRPId() != 0);
		...
		if (tr_L_1_N_valid)
			h2_y_vs_x_L_1_N_no_sel->Fill(tr_L_1_N.getX(), tr_L_1_N.getY());
		if (tr_R_1_N_valid)
			h2_y_vs_x_R_1_N_no_sel->Fill(tr_R_1_N.getX(), tr_R_1_N.getY());
		if (tr_R_1_F_valid)
			h2_y_vs_x_R_1_F_no_sel->Fill(tr_R_1_F.getX(), tr_R_1_F.getY());

		if (tr_L_1_N_valid && tr_L_1_F_valid)
		{
			h2_x_L_1_F_vs_x_L_1_N_before->Fill(tr_L_1_N.getX(), tr_L_1_F.getX());
			h2_y_L_1_F_vs_y_L_1_N_before->Fill(tr_L_1_N.getY(), tr_L_1_F.getY());

			double cq1 = tr_L_1_F.getX() + cfg.cut1_a * tr_L_1_N.getX() + cfg.cut1_c;
			h_q_cut1_before->Fill(cq1);
			bool cut1_val = (fabs(cq1) < cfg.n_si * cfg.cut1_si);

			double cq3 = tr_L_1_F.getY() + cfg.cut3_a * tr_L_1_N.getY() + cfg.cut3_c;
			...
			if (cuts_passed)
			{
				...
				h2_x_L_1_F_vs_x_L_1_N_after->Fill(tr_L_1_N.getX(), tr_L_1_F.getX());
				h2_y_L_1_F_vs_y_L_1_N_after->Fill(tr_L_1_N.getY(), tr_L_1_F.getY());

				p_x_L_1_F_vs_x_L_1_N_after->Fill(tr_L_1_N.getX(), tr_L_1_F.getX());
				p_y_L_1_F_vs_y_L_1_N_after->Fill(tr_L_1_N.getY(), tr_L_1_F.getY());

				h_q_cut1_after->Fill(cq1);
				h_q_cut3_after->Fill(cq3);

				int idx = g_y_vs_x_L_1_N_sel->GetN();
				g_y_vs_x_L_1_N_sel->SetPoint(idx, tr_L_1_N.getX(), tr_L_1_N.getY());
				g_y_vs_x_L_1_F_sel->SetPoint(idx, tr_L_1_F.getX(), tr_L_1_F.getY());

				h2_y_vs_x_L_1_N_sel->Fill(tr_L_1_N.getX(), tr_L_1_N.getY());
				h2_y_vs_x_L_1_F_sel->Fill(tr_L_1_F.getX(), tr_L_1_F.getY());

				p_y_vs_x_L_1_N_sel.Fill(tr_L_1_N.getX(), tr_L_1_N.getY());
				p_y_vs_x_L_1_F_sel.Fill(tr_L_1_F.getX(), tr_L_1_F.getY());
			}
		}

		if (tr_R_1_N_valid && tr_R_1_F_valid)
		{
			h2_x_R_1_F_vs_x_R_1_N_before->Fill(tr_R_1_N.getX(), tr_R_1_F.getX());
			h2_y_R_1_F_vs_y_R_1_N_before->Fill(tr_R_1_N.getY(), tr_R_1_F.getY());

			double cq2 = tr_R_1_F.getX() + cfg.cut2_a * tr_R_1_N.getX() + cfg.cut2_c;
			h_q_cut2_before->Fill(cq2);
			bool cut2_val = (fabs(cq2) < cfg.n_si * cfg.cut2_si);

			double cq4 = tr_R_1_F.getY() + cfg.cut4_a * tr_R_1_N.getY() + cfg.cut4_c;
			...
			if (cuts_passed)
			{
				...
				h2_x_R_1_F_vs_x_R_1_N_after->Fill(tr_R_1_N.getX(), tr_R_1_F.getX());
				h2_y_R_1_F_vs_y_R_1_N_after->Fill(tr_R_1_N.getY(), tr_R_1_F.getY());

				p_x_R_1_F_vs_x_R_1_N_after->Fill(tr_R_1_N.getX(), tr_R_1_F.getX());
				p_y_R_1_F_vs_y_R_1_N_after->Fill(tr_R_1_N.getY(), tr_R_1_F.getY());

				h_q_cut2_after->Fill(cq2);
				h_q_cut4_after->Fill(cq4);

				int idx = g_y_vs_x_R_1_N_sel->GetN();
				g_y_vs_x_R_1_N_sel->SetPoint(idx, tr_R_1_N.getX(), tr_R_1_N.getY());
				g_y_vs_x_R_1_F_sel->SetPoint(idx, tr_R_1_F.getX(), tr_R_1_F.getY());

				h2_y_vs_x_R_1_N_sel->Fill(tr_R_1_N.getX(), tr_R_1_N.getY());
				h2_y_vs_x_R_1_F_sel->Fill(tr_R_1_F.getX(), tr_R_1_F.getY());

				p_y_vs_x_R_1_N_sel.Fill(tr_R_1_N.getX(), tr_R_1_N.getY());
	...
	p_x_L_1_F_vs_x_L_1_N_after->Fit(ff_pol1, "Q", "", fx_min, fx_max);
	...
	p_x_R_1_F_vs_x_R_1_N_after->Fit(ff_pol1, "Q", "", fx_min, fx_max);
	printf("\tcut2_a = %+.3f; cut2_c = %+.3f; cut2_si = 0.20;\n", -ff_pol1->GetParameter(1), -ff_pol1->GetParameter(0));

	fx_min = (cfg.aligned) ? -2.5 : -6.5;
	fx_max = (cfg.aligned) ? -2.5 : +6.5;

	p_y_L_1_F_vs_y_L_1_N_after->Fit(ff_pol1, "Q", "", fx_min, fx_max);
	printf("\tcut3_a = %+.3f; cut3_c = %+.3f; cut3_si = 0.15;\n", -ff_pol1->GetParameter(1), -ff_pol1->GetParameter(0));

	p_y_R_1_F_vs_y_R_1_N_after->Fit(ff_pol1, "Q", "", fx_min, fx_max);
	...
	WriteCutPlot(h2_x_L_1_F_vs_x_L_1_N_before, cfg.cut1_a, cfg.cut1_c, cfg.cut1_si, "canvas_before");
	WriteCutPlot(h2_x_L_1_F_vs_x_L_1_N_after, cfg.cut1_a, cfg.cut1_c, cfg.cut1_si, "canvas_after");
	p_x_L_1_F_vs_x_L_1_N_after->Write();
	h_q_cut1_before->Write();
	h_q_cut1_after->Write();

	gDirectory = d_cuts->mkdir("cut 2");
	WriteCutPlot(h2_x_R_1_F_vs_x_R_1_N_before, cfg.cut2_a, cfg.cut2_c, cfg.cut2_si, "canvas_before");
	WriteCutPlot(h2_x_R_1_F_vs_x_R_1_N_after, cfg.cut2_a, cfg.cut2_c, cfg.cut2_si, "canvas_after");
	p_x_R_1_F_vs_x_R_1_N_after->Write();
	h_q_cut2_before->Write();
	h_q_cut2_after->Write();

	gDirectory = d_cuts->mkdir("cut 3");
	WriteCutPlot(h2_y_L_1_F_vs_y_L_1_N_before, cfg.cut3_a, cfg.cut3_c, cfg.cut3_si, "canvas_before");
	WriteCutPlot(h2_y_L_1_F_vs_y_L_1_N_after, cfg.cut3_a, cfg.cut3_c, cfg.cut3_si, "canvas_after");
	p_y_L_1_F_vs_y_L_1_N_after->Write();
	h_q_cut3_before->Write();
	h_q_cut3_after->Write();

	gDirectory = d_cuts->mkdir("cut 4");
	WriteCutPlot(h2_y_R_1_F_vs_y_R_1_N_before, cfg.cut4_a, cfg.cut4_c, cfg.cut4_si, "canvas_before");
	WriteCutPlot(h2_y_R_1_F_vs_y_R_1_N_after, cfg.cut4_a, cfg.cut4_c, cfg.cut4_si, "canvas_after");
	p_y_R_1_F_vs_y_R_1_N_after->Write();
